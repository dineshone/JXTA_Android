...
public class NettyTransport implements Module {
    ...
    /*
     * d0d0 The method signature for the method NioClientSocketChannelFactory has changed with the latest version of netty.
     ...
     * Naah ... i am going to the older lib....
     * */ 
...
// 		return new NioClientSocketChannelFactory(Executors.newCachedThreadPool(), Executors.newCachedThreadPool());        
    ...
    /*
     * d0d0 The method signature for the method NioServerSocketChannelFactory has changed with the latest version of netty.
     * In the new version the parameters Executors.newCachedThreadPool() are unnecessary. 
     * A call to the constructor with no parameters does the same trick. 
     * Naah ... i am going to the older lib....
     * */ 
