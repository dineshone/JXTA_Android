...
public class SharedScheduledThreadPoolExecutor extends ScheduledThreadPoolExecutor {
	...
	public ScheduledFuture<?> scheduleAtFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
	    return super.scheduleAtFixedRate(new RunMetricsWrapper<Void>(longTaskMonitorExecutor, command), initialDelay, period, unit);
	}
	
	@Override
	public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
	    return super.scheduleWithFixedDelay(new RunMetricsWrapper<Void>(longTaskMonitorExecutor, command), initialDelay, delay, unit);
	}
	...
	public <T extends Object> java.util.concurrent.Future<T> submit(Runnable task, T result) {
	    return super.submit(new RunMetricsWrapper<Void>(longTaskMonitorExecutor, task), result);
	};
	
	@Override
	public void execute(Runnable command) {
	    super.execute(new RunMetricsWrapper<Void>(longTaskMonitorExecutor, command));
	}
}
